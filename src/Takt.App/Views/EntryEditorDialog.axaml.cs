...
/// <summary>
/// The entry editor dialog. Typing in the issue search is debounced here; the view
/// model runs the query and owns the results.
/// </summary>
public sealed partial class EntryEditorDialog : Window
{
    ...
    public EntryEditorDialog(EntryEditorViewModel viewModel)
    {
